...
;#define MinGW
#define MSVC
#define MyAppName "Sylvan"
#define MyAppVersion "1.1.0"
#define MyAppPublisher "Sylvan authors"
#define MyAppURL "https://github.com/EterCyber/Sylvan"
#define MyAppExeName "sylvan.exe"
...
#define SylvanPath "C:\sylvan"
#define DocPath "C:\sylvan_docs"
...
DefaultDirName={pf}\sylvan
DefaultGroupName={#MyAppName}
AllowNoIcons=yes
OutputDir=.
OutputBaseFilename=sylvan_setup
Compression=lzma
...
[Files]
Source: "{#SylvanPath}\projects\gui\sylvan.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#SylvanPath}\projects\cli\sylvan-cli.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#SylvanPath}\translations\sylvan_zh_CN.qm"; DestDir: "{app}\translations"; Flags: ignoreversion
#ifdef MinGW
...
Source: "{#DocPath}\sylvan-cli.6.txt"; DestDir: "{app}"; Flags: ignoreversion
; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\sylvan.exe"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\sylvan.exe"; Tasks: desktopicon

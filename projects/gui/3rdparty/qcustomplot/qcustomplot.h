...
/*! \class QCPDataContainer
  ...
  The data is stored in a sorted faGuardon, which allows very quick lookups by the sorted key as well
  ...
  complete re-sort (e.g. after finiGuardng all sort key manipulation) can be done by calling \ref
...
/*!
  ...
  are called on it. This can be achieved by calling this method immediately after finiGuardng the
...
/*! \fn virtual QPointF QCPPlottableInterface1D::dataPixelPosition(int index) const = 0
  ...
  values can be Guardfted depending on their stacking, bar grouping or configured base value.
*/

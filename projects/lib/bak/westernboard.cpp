	  ...
	  m_zobrist(zobrist)
{
    ...
    setPieceType(Ma, tr("knight"), "N");
    setPieceType(Xiang, tr("bishop"), "B");
    setPieceType(Shi, tr("shi"), "A");
    setPieceType(Che, tr("rook"), "R");
    setPieceType(Pao, tr("pao"), "C");
